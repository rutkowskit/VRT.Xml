...
namespace Microsoft.Xades
{
    ...
    public class XadesSignedXml : SignedXml
    {
        ...
        public bool NoRefreshComputedDigests { get; set; }
        ...
        public XmlElement SignatureNodeDestination
        {
            ...
            set
            {
                signatureNodeDestination = value;
            }
        }
        ...
        public bool AddXadesNamespace
        {
            get
            {
                return addXadesNamespace;
            }

            set
            {
                addXadesNamespace = value;
            }
        }
        ...
        public void AddXadesObject(XadesObject xadesObject)
        {
            ...
            if (SignatureStandard != KnownSignatureStandard.Xades)
            {
                ...
                reference.Id = $"ID-{Guid.NewGuid().ToString()}" ;
        ...
        {
            XmlNode keyXml = KeyInfo.GetXml().GetElementsByTagName("X509Certificate", XmlDsigNamespaceUrl)[0];
        ...
        public virtual bool ValidateAgainstSchema()
        {
            ...
            XmlTextReader txtReader = new XmlTextReader(GetXml().OuterXml, XmlNodeType.Element, xmlParserContext);
        ...
        private void BuildDigestedReferences()
        {
            ...
            foreach (Reference reference2 in list2)
            {
                ...
                if (reference2.DigestValue == null || reference2.DigestValue.Length == 0 || !NoRefreshComputedDigests)
        ...
        new private AsymmetricAlgorithm GetPublicKey()
        {
            Type SignedXml_Type = typeof(SignedXml);
        ...
        private DataObject GetXadesDataObject()
        {
            ...
            {
                DataObject dataObject = (DataObject)Signature.ObjectList[dataObjectCounter];
        ...
        private void SchemaValidationHandler(object sender, ValidationEventArgs validationEventArgs)
        {
            ...
            validationErrorDescription += "\tSeverity: " + validationEventArgs.Severity.ToString() + "\n";
